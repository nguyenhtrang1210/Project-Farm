...
<table cellpadding="10">
    <tr>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        else if (!isset($_SESSION['id3']))
                        {
                            $_SESSION['id3']=$kho['id'];
                        }else if (!isset($_SESSION['id4']))
                        {
                            $_SESSION['id4']=$kho['id'];
                        }else if (!isset($_SESSION['id5']))
                        {
                            $_SESSION['id5']=$kho['id'];
                        }
                        ?></td>
        ...
        <td>
            ...
            <button><a href="giohang.php">Thêm vào giỏ hàng</a></button>
